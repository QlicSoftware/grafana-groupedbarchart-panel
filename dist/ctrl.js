                ...
                _createClass(GroupedBarChartCtrl, [{
                    ...
                    value: function onDataReceived(dataList) {
                        if (dataList && dataList.length) {
                            var columns = dataList[0].columns.map(function (_ref) {
                                var text = _ref.text;
                                return text;
                            });
                            this.data = dataList[0].rows.map(function (row) {
                                return columns.reduce(function (accumulator, value, index) {
                                    return Object.assign(accumulator, _defineProperty({}, value, row[index]));
                                }, {});
                            });
                        } else {
                        ...
                        var groupedBarChart = function () {
                            ...
                            _createClass(groupedBarChart, [{
                                ...
                                value: function draw() {
                                    ...
                                    this.height = this.element.parentNode.clientHeight * 0.85;
                                ...
                                value: function addBar() {
                                    ...
                                    if (this.barValuesShow) {
                                        ...
                                        }).attr('y', 30).attr('dy', '.35em').style('fill', '' + this.fontColor).text(function (d) {
